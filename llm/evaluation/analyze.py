...
def run_one(model, input_file, output_file, output_dir):
    """
    ...
    """
    command = ["python3", "main.py", "--input_file", input_file, "--model", model, "--output_dir", output_dir]
    try:
    ...
    for model in models:
        ...
        for i in range(len(sources)):
            ...
            # Generate
                ...
                run_one(model, source, generate_log_file, build_path)
