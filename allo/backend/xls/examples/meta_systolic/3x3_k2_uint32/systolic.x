...
pub proc SystolicArray {
  arg0: chan<u32[2][3]> in;
  arg1: chan<u32[3][2]> in;
  out0: chan<u32[3][3]> out;
  from_hor: chan<u32>[u32:3 + u32:1][u32:3] in;
  to_hor: chan<u32>[u32:3 + u32:1][u32:3] out;
  from_vert: chan<u32>[u32:3][u32:3 + u32:1] in;
  to_vert: chan<u32>[u32:3][u32:3 + u32:1] out;
  result_chans_in: chan<u32>[u32:3][u32:3] in;

  config(arg0: chan<u32[2][3]> in, arg1: chan<u32[3][2]> in, out0: chan<u32[3][3]> out) {
    let (to_hor, from_hor) = chan<u32, u32:1>[u32:3 + u32:1][u32:3]("hor_chans");
    let (to_vert, from_vert) = chan<u32, u32:1>[u32:3][u32:3 + u32:1]("vert_chans");
    let (result_chans_out, result_chans_in) = chan<u32, u32:1>[u32:3][u32:3]("result_chans");
    unroll_for! (row, _): (u32, ()) in u32:0..u32:3 {
      unroll_for! (col, _): (u32, ()) in u32:0..u32:3 {
  ...
  init { ([[u32:0, u32:0], [u32:0, u32:0], [u32:0, u32:0]], [[u32:0, u32:0, u32:0], [u32:0, u32:0, u32:0]], u32:0, false) }

  next(state: (u32[2][3], u32[3][2], u32, bool)) {
    ...
    let tok_b2 = if index0 < u32:2 {
      send(tok_b1, to_vert[u32:0][u32:2], b_mat2[index0][u32:2])
    } else {
      tok_b1
    };
    let tok2 = tok_b2;
    let _ = recv_non_blocking(token(), from_hor[u32:0][u32:3], u32:0);
    let _ = recv_non_blocking(token(), from_hor[u32:1][u32:3], u32:0);
    let _ = recv_non_blocking(token(), from_hor[u32:2][u32:3], u32:0);
    let _ = recv_non_blocking(token(), from_vert[u32:3][u32:0], u32:0);
    let _ = recv_non_blocking(token(), from_vert[u32:3][u32:1], u32:0);
    let _ = recv_non_blocking(token(), from_vert[u32:3][u32:2], u32:0);
    ...
    if index0 == u32:2 {
      ...
      let (t10, c10) = recv(t02, result_chans_in[u32:1][u32:0]);
      let (t11, c11) = recv(t10, result_chans_in[u32:1][u32:1]);
      let (t12, c12) = recv(t11, result_chans_in[u32:1][u32:2]);
      let (t20, c20) = recv(t12, result_chans_in[u32:2][u32:0]);
      let (t21, c21) = recv(t20, result_chans_in[u32:2][u32:1]);
      let (t22, c22) = recv(t21, result_chans_in[u32:2][u32:2]);
      let c = [[c00, c01, c02], [c10, c11, c12], [c20, c21, c22]];
      let tok_send = send(t22, out0, c);
      ([[u32:0, u32:0], [u32:0, u32:0], [u32:0, u32:0]], [[u32:0, u32:0, u32:0], [u32:0, u32:0, u32:0]], u32:0, false)
    } else {
