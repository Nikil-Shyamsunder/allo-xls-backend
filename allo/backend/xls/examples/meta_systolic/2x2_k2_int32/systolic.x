...
pub proc SystolicArray {
  ...
  from_hor: chan<s32>[u32:2 + u32:1][u32:2] in;
  to_hor: chan<s32>[u32:2 + u32:1][u32:2] out;
  from_vert: chan<s32>[u32:2][u32:2 + u32:1] in;
  to_vert: chan<s32>[u32:2][u32:2 + u32:1] out;
  result_chans_in: chan<s32>[u32:2][u32:2] in;

  config(arg0: chan<s32[2][2]> in, arg1: chan<s32[2][2]> in, out0: chan<s32[2][2]> out) {
    let (to_hor, from_hor) = chan<s32, u32:1>[u32:2 + u32:1][u32:2]("hor_chans");
    let (to_vert, from_vert) = chan<s32, u32:1>[u32:2][u32:2 + u32:1]("vert_chans");
    let (result_chans_out, result_chans_in) = chan<s32, u32:1>[u32:2][u32:2]("result_chans");
  ...
  init { ([[s32:0, s32:0], [s32:0, s32:0]], [[s32:0, s32:0], [s32:0, s32:0]], u32:0, false) }

  next(state: (s32[2][2], s32[2][2], u32, bool)) {
    ...
    let tok2 = tok_b1;
    let _ = recv_non_blocking(token(), from_hor[u32:0][u32:2], s32:0);
    let _ = recv_non_blocking(token(), from_hor[u32:1][u32:2], s32:0);
    let _ = recv_non_blocking(token(), from_vert[u32:2][u32:0], s32:0);
    let _ = recv_non_blocking(token(), from_vert[u32:2][u32:1], s32:0);
    ...
    if index0 == u32:2 {
      ...
      ([[s32:0, s32:0], [s32:0, s32:0]], [[s32:0, s32:0], [s32:0, s32:0]], u32:0, false)
    } else {
