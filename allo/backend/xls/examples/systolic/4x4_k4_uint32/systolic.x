...
pub proc SystolicArray {
  arg0: chan<u32[4][4]> in;
  arg1: chan<u32[4][4]> in;
  out0: chan<u32[4][4]> out;
  from_hor: chan<u32>[u32:4 + u32:1][u32:4] in;
  to_hor: chan<u32>[u32:4 + u32:1][u32:4] out;
  from_vert: chan<u32>[u32:4][u32:4 + u32:1] in;
  to_vert: chan<u32>[u32:4][u32:4 + u32:1] out;
  result_chans_in: chan<u32>[u32:4][u32:4] in;

  config(arg0: chan<u32[4][4]> in, arg1: chan<u32[4][4]> in, out0: chan<u32[4][4]> out) {
    let (to_hor, from_hor) = chan<u32, u32:1>[u32:4 + u32:1][u32:4]("hor_chans");
    let (to_vert, from_vert) = chan<u32, u32:1>[u32:4][u32:4 + u32:1]("vert_chans");
    let (result_chans_out, result_chans_in) = chan<u32, u32:1>[u32:4][u32:4]("result_chans");
  ...
  init { ([[u32:0, u32:0, u32:0, u32:0], [u32:0, u32:0, u32:0, u32:0], [u32:0, u32:0, u32:0, u32:0], [u32:0, u32:0, u32:0, u32:0]], [[u32:0, u32:0, u32:0, u32:0], [u32:0, u32:0, u32:0, u32:0], [u32:0, u32:0, u32:0, u32:0], [u32:0, u32:0, u32:0, u32:0]], u32:0, false) }

  next(state: (u32[4][4], u32[4][4], u32, bool)) {
    ...
    if index0 == u32:4 {
      ...
      ([[u32:0, u32:0, u32:0, u32:0], [u32:0, u32:0, u32:0, u32:0], [u32:0, u32:0, u32:0, u32:0], [u32:0, u32:0, u32:0, u32:0]], [[u32:0, u32:0, u32:0, u32:0], [u32:0, u32:0, u32:0, u32:0], [u32:0, u32:0, u32:0, u32:0], [u32:0, u32:0, u32:0, u32:0]], u32:0, false)
    } else {
