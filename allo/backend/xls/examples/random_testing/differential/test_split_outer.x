// Differential testing: LLM vs Compiler GEMM (split_outer)
...
// Lowering of:
//   def allo_gemm_llm(A: int32[32, 32], B: int32[32, 32]) -> int32[32, 32]:
//      C: int32[32, 32] = 0
...
pub fn allo_gemm_llm(A: Mat32x32, B: Mat32x32) -> Mat32x32 {
...
fn prop_gemm_split_outer_equivalence(A: s32[32][32], B: s32[32][32]) -> bool {
