// Differential testing: LLM vs Compiler GEMM (split_inner)
...
fn allo_gemm_llm(A: s32[K][M], B: s32[N][K]) -> s32[N][M] {
  // Initialize C to 0
...
fn prop_gemm_split_inner_equivalence(A: s32[32][32], B: s32[32][32]) -> bool {
