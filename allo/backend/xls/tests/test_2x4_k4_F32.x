...
pub proc SystolicArray {
  ...
  next(state: ()) {
    ...
    let (a_fifo_0_4_s, a_fifo_0_4_r) = chan<F32>("a_fifo_0_4");
    ...
    let (a_fifo_1_4_s, a_fifo_1_4_r) = chan<F32>("a_fifo_1_4");
    ...
    let (b_fifo_3_0_s, b_fifo_3_0_r) = chan<F32>("b_fifo_3_0");
    let (b_fifo_3_1_s, b_fifo_3_1_r) = chan<F32>("b_fifo_3_1");
    let (b_fifo_3_2_s, b_fifo_3_2_r) = chan<F32>("b_fifo_3_2");
    ...
    let (c_out_0_3_s, c_out_0_3_r) = chan<F32>("c_out_0_3");
    ...
    let (c_out_1_3_s, c_out_1_3_r) = chan<F32>("c_out_1_3");
    ...
    let (tok, _) = recv(tok, b_fifo_3_2_r);
    let (tok, _) = recv(tok, b_fifo_3_2_r);
    let C = F32[2][4]:[[c_0_0, c_0_1, c_0_2, c_0_3], [c_1_0, c_1_1, c_1_2, c_1_3]];
