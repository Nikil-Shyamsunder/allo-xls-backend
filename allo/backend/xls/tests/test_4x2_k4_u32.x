...
pub proc SystolicArray {
  ...
  next(state: ()) {
    ...
    let (a_fifo_3_0_s, a_fifo_3_0_r) = chan<u32>("a_fifo_3_0");
    let (a_fifo_3_1_s, a_fifo_3_1_r) = chan<u32>("a_fifo_3_1");
    let (a_fifo_3_2_s, a_fifo_3_2_r) = chan<u32>("a_fifo_3_2");
    ...
    let (b_fifo_0_4_s, b_fifo_0_4_r) = chan<u32>("b_fifo_0_4");
    ...
    let (b_fifo_1_4_s, b_fifo_1_4_r) = chan<u32>("b_fifo_1_4");
    ...
    let (c_out_3_0_s, c_out_3_0_r) = chan<u32>("c_out_3_0");
    let (c_out_3_1_s, c_out_3_1_r) = chan<u32>("c_out_3_1");
    ...
    let (tok, _) = recv(tok, b_fifo_1_4_r);
    let (tok, _) = recv(tok, b_fifo_1_4_r);
    let C = u32[4][2]:[[c_0_0, c_0_1], [c_1_0, c_1_1], [c_2_0, c_2_1], [c_3_0, c_3_1]];
