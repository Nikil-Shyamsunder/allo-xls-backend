...
pub proc SystolicArray {
  ...
  next(state: ()) {
    ...
    let (a_fifo_2_0_s, a_fifo_2_0_r) = chan<u32>("a_fifo_2_0");
    let (a_fifo_2_1_s, a_fifo_2_1_r) = chan<u32>("a_fifo_2_1");
    let (a_fifo_2_2_s, a_fifo_2_2_r) = chan<u32>("a_fifo_2_2");
    let (a_fifo_2_3_s, a_fifo_2_3_r) = chan<u32>("a_fifo_2_3");
    ...
    let (b_fifo_0_3_s, b_fifo_0_3_r) = chan<u32>("b_fifo_0_3");
    ...
    let (b_fifo_1_3_s, b_fifo_1_3_r) = chan<u32>("b_fifo_1_3");
    ...
    let (b_fifo_2_3_s, b_fifo_2_3_r) = chan<u32>("b_fifo_2_3");
    ...
    let (c_out_2_0_s, c_out_2_0_r) = chan<u32>("c_out_2_0");
    let (c_out_2_1_s, c_out_2_1_r) = chan<u32>("c_out_2_1");
    let (c_out_2_2_s, c_out_2_2_r) = chan<u32>("c_out_2_2");
    ...
    let (tok, _) = recv(tok, b_fifo_2_3_r);
    let (tok, _) = recv(tok, b_fifo_2_3_r);
    let C = u32[3][3]:[[c_0_0, c_0_1, c_0_2], [c_1_0, c_1_1, c_1_2], [c_2_0, c_2_1, c_2_2]];
