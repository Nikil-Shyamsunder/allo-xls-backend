...
pub proc SystolicArray {
  ...
  next(state: (u32[2][2], u32[2][2], u32, bool)) {
    ...
    let tok2 = tok_b1;
    let _ = recv_non_blocking(token(), from_hor[u32:0][u32:2], u32:0);
    let _ = recv_non_blocking(token(), from_hor[u32:1][u32:2], u32:0);
    let _ = recv_non_blocking(token(), from_vert[u32:2][u32:0], u32:0);
    let _ = recv_non_blocking(token(), from_vert[u32:2][u32:1], u32:0);
