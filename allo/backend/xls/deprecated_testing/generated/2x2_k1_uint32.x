...
pub proc SystolicArray {
  ...
  config(
    ...
    let (a_fifo_0_0_s, a_fifo_0_0_r) = chan<u32, u32:1>("a_fifo_0_0");
    let (a_fifo_0_1_s, a_fifo_0_1_r) = chan<u32, u32:1>("a_fifo_0_1");
    let (a_fifo_0_2_s, a_fifo_0_2_r) = chan<u32, u32:1>("a_fifo_0_2");
    let (a_fifo_1_0_s, a_fifo_1_0_r) = chan<u32, u32:1>("a_fifo_1_0");
    let (a_fifo_1_1_s, a_fifo_1_1_r) = chan<u32, u32:1>("a_fifo_1_1");
    let (a_fifo_1_2_s, a_fifo_1_2_r) = chan<u32, u32:1>("a_fifo_1_2");
    let (b_fifo_0_0_s, b_fifo_0_0_r) = chan<u32, u32:1>("b_fifo_0_0");
    let (b_fifo_0_1_s, b_fifo_0_1_r) = chan<u32, u32:1>("b_fifo_0_1");
    let (b_fifo_0_2_s, b_fifo_0_2_r) = chan<u32, u32:1>("b_fifo_0_2");
    let (b_fifo_1_0_s, b_fifo_1_0_r) = chan<u32, u32:1>("b_fifo_1_0");
    let (b_fifo_1_1_s, b_fifo_1_1_r) = chan<u32, u32:1>("b_fifo_1_1");
    let (b_fifo_1_2_s, b_fifo_1_2_r) = chan<u32, u32:1>("b_fifo_1_2");
    let (c_out_0_0_s, c_out_0_0_r) = chan<u32, u32:1>("c_out_0_0");
    let (c_out_0_1_s, c_out_0_1_r) = chan<u32, u32:1>("c_out_0_1");
    let (c_out_1_0_s, c_out_1_0_r) = chan<u32, u32:1>("c_out_1_0");
    let (c_out_1_1_s, c_out_1_1_r) = chan<u32, u32:1>("c_out_1_1");
    spawn PE<u32:1>(a_fifo_0_0_r, b_fifo_0_0_r, a_fifo_0_1_s, b_fifo_0_1_s, c_out_0_0_s);
    spawn PE<u32:1>(a_fifo_0_1_r, b_fifo_1_0_r, a_fifo_0_2_s, b_fifo_1_1_s, c_out_0_1_s);
    spawn PE<u32:1>(a_fifo_1_0_r, b_fifo_0_1_r, a_fifo_1_1_s, b_fifo_0_2_s, c_out_1_0_s);
    spawn PE<u32:1>(a_fifo_1_1_r, b_fifo_1_1_r, a_fifo_1_2_s, b_fifo_1_2_s, c_out_1_1_s);
